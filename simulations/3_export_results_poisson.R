...
for (kernel_choice in kernel_choices) {
  for (seed_value in seed_values) {
    ...
    sim_data_file <- paste0(wd, "code/simulations/data/simulated_pois_data_", kernel_choice, "_seed_", seed_value, ".rds")
    stan_fit_file_ICM <- paste0(wd, "code/simulations/results/poisson/ICM/stan_fit_", kernel_choice, "_seed_", seed_value, ".rds")
    stan_fit_file_sep <- paste0(wd, "code/simulations/results/poisson/sep/stan_fit_", kernel_choice, "_seed_", seed_value, ".rds")
    stan_fit_file_nonsep <- paste0(wd, "code/simulations/results/poisson/nonsep/stan_fit_", kernel_choice, "_seed_", seed_value, ".rds")
...
for (model_choice in model_choices) {
  for (kernel_choice in kernel_choices) {
    for (seed_value in seed_values) {
      ...
      #true_mean<- treated_data$poisson_mean
...
table_to_save %>%
  ...
  cat(file = paste0(wd, "/code/simulations/results/poisson/summary_table_mean_NNGP.tex"))


# Save results
saveRDS(summary_table_pois, file=paste0(wd, "/code/simulations/results/poisson/summary_table_mean_NNGP.rds"))
